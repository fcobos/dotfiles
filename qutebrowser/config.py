...
# Type: List of Url
c.content.host_blocking.lists = ['https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/gambling/hosts', 'https://pgl.yoyo.org/adservers/serverlist.php?showintro=0;hostformat=hosts']
